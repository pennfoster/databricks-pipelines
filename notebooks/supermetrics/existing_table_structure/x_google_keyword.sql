...
GO
    CREATE TABLE [dbo].[T021_GoogleKeyword](
        ...
        [C021_CampaignLabels] [varchar](255) NULL,
        [C021_AdGroupLabels] [varchar](255) NULL,
        [C021_Labels] [varchar](255) NULL,
...
GO
ALTER TABLE
    [dbo].[T021_GoogleKeyword]
ADD
    CONSTRAINT [DF__T021_Goog__DateR__5E54FF49] DEFAULT (getdate()) FOR [DateRecordAddedToTable]
GO