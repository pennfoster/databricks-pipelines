...
for i in query_list:
    ...
    select_query = f"""
        select
            ...
            videoimpressions::decimal(38, 4) as videoimpressions,
            videoviews::decimal(38, 4) as videoviews,
            videoviewrate,
            ...
            videoquartile25views::decimal(38, 4) as watch25percentviews,
            videoquartile50views::decimal(38, 4) as watch50percentviews,
            videoquartile75views::decimal(38, 4) as watch75percentviews,
            videoquartile100views::decimal(38, 4) as watch100percentviews,
            gmailforwards::decimal(38, 4) as gmailforwards,
            gmailsaves::decimal(38, 4) as gmailsaves,
            gmailsecondaryclicks::decimal(38, 4) as gmailsecondaryclicks,
