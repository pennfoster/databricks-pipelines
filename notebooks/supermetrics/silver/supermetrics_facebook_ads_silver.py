...
campaignid,
campaignstatus,
try_cast(campaigndailybudget as float) as campaigndailybudget,
campaignstartdate,
campaignenddate,
adsetname,
adsetid,
...
try_cast(reach as float) as reach,
try_cast(impressions as float) as impressions,
try_cast(cpmcostper1000impressions as float) as cpmcostper1000impressions,
try_cast(linkclicks as float) as linkclicks,
try_cast(uniquelinkclicks as float) as uniquelinkclicks,
ctrlinkclickthroughrate,
try_cast(cpccostperlinkclick as float) as cpccostperlinkclick,
try_cast(costperuniquelinkclick as float) as costperuniquelinkclick,
try_cast(threesecondvideoviews as float) as threesecondvideoviews,
try_cast(uniquethreesecondvideoviews as float) as uniquethreesecondvideoviews,
try_cast(thirtysecondvideoviews as float) as thirtysecondvideoviews,
try_cast(videowatchesat25percent as float) as videowatchesat25percent,
try_cast(videowatchesat50percent as float) as videowatchesat50percent,
try_cast(videowatchesat75percent as float) as videowatchesat75percent,
try_cast(videowatchesat95percent as float) as videowatchesat95percent,
try_cast(videowatchesat100percent as float) as videowatchesat100percent,
try_cast(videoaveragewatchtime as float) as videoaveragewatchtime,
try_cast(clickstoplayvideo as float) as clickstoplayvideo,
try_cast(uniqueclickstoplayvideo as float) as uniqueclickstoplayvideo,
try_cast(avgcanvasviewtimeseconds as float) as avgcanvasviewtimeseconds,
avgcanvasviewpercentage,
try_cast(costperthreesecondvideoview as float) as costperthreesecondvideoview,
try_cast(websiteconversions as float) as websiteconversions,
websiteconversionrate,
try_cast(websitecustomconversions as float) as websitecustomconversions,
try_cast(websiteleads as float) as websiteleads,
try_cast(websitepurchases as float) as websitepurchases,
try_cast(costperwebsiteconversion as float) as costperwebsiteconversion,
try_cast(costperwebsitecustomconversions as float) as costperwebsitecustomconversions,
try_cast(costperwebsitelead as float) as costperwebsitelead,
try_cast(costperwebsitepurchase as float) as costperwebsitepurchase,
try_cast(videoplayactions as float) as videoplayactions,
try_cast(frequency as float) as frequency,
mkwid,
pubcode,
adkey,
