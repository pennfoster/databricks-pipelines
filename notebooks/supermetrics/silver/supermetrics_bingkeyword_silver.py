...
for i in query_list:
    ...
    select_query = f"""
        select
            ...
            adgrouplabels,
            keywordlabels,
            ifnull(impressions::int, 0) as impressions,
            ifnull(clicks::int, 0) as clicks,
            ifnull(spend::decimal(38,4), 0) as cost,
            ifnull(ctr::decimal(38,4), 0) as ctrpercent,
            ...
            ifnull(try_cast(qualityscore as int), 0) as qualityscore,
            ifnull(conversions::int, 0) as conversions,
            conversionrate,
