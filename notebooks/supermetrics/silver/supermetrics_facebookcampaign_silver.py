...
for i in query_list:
    ...
    select_query = f"""
        select
            ...
            campaignstatus,
            ifnull(campaign_daily_budget::decimal(38, 4) as campaigndailybudget,
            ...
            impressions::decimal(38, 4), 0) as impressions,
            ifnull(cpm::decimal(38, 4), 0) as cpmcostper1000impressions,
            action_link_click::decimal(38, 4), 0) as linkclicks,
