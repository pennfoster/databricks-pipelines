...
for i in query_list:
    ...
    select_query = f"""
        select
            ...
            campaignstatus,
            campaign_daily_budget::decimal(38, 4) as campaigndailybudget,
            campaign_start_date as campaignstartdate,
            campaign_end_date::string as campaignenddate,
            cost::decimal(38, 4) as cost,
            reach::decimal(38, 4) as reach,
            impressions::decimal(38, 4) as impressions,
            cpm::decimal(38, 4) as cpmcostper1000impressions,
            action_link_click::decimal(38, 4) as linkclicks,
            unique_action_link_click::decimal(38, 4) as uniquelinkclicks,
            link_ctr as ctrlinkclickthroughrate,
            cplc::decimal(38, 4) as cpccostperlinkclick,
            ucplc::decimal(38, 4) as costperuniquelinkclick,
            action_video_view::decimal(38, 4) as threesecondvideoviews,
            unique_action_video_view::decimal(38, 4) as uniquethreesecondvideoviews,
            video_30_sec_watched_actions::decimal(38, 4) as thirtysecondvideoviews,
            video_p25_watched_actions::decimal(38, 4) as videowatchesat25percent,
            video_p50_watched_actions::decimal(38, 4) as videowatchesat50percent,
            video_p75_watched_actions::decimal(38, 4) as videowatchesat75percent,
            video_p95_watched_actions::decimal(38, 4) as videowatchesat95percent,
            video_p100_watched_actions::decimal(38, 4) as videowatchesat100percent,
            video_average_watch_time::decimal(38, 4) as videoaveragewatchtime,
            action_video_play::decimal(38, 4) as clickstoplayvideo,
            unique_action_video_play::decimal(38, 4) as uniqueclickstoplayvideo,
            canvas_avg_view_time::decimal(38, 4) as avgcanvasviewtimeseconds,
            canvas_avg_view_percent::string as avgcanvasviewpercentage,
            cost_per_3s_video_view::decimal(38, 4) as costperthreesecondvideoview,
            offsite_conversions::decimal(38, 4) as websiteconversions,
            offsite_conversion_rate as websiteconversionrate,
            offsite_conversions_fb_pixel_custom::decimal(38, 4) as websitecustomconversions,
            offsite_conversions_fb_pixel_lead::decimal(38, 4) as websiteleads,
            offsite_conversions_fb_pixel_purchase::decimal(38, 4) as websitepurchases,
            cost_per_website_conversion::decimal(38, 4) as costperwebsiteconversion,
            cost_per_website_custom_conversion::decimal(38, 4) as costperwebsitecustomconversions,
            cost_per_website_lead::decimal(38, 4) as costperwebsitelead,
            cost_per_website_purchase::decimal(38, 4) as costperwebsitepurchase,
            video_play_actions::decimal(38, 4) as videoplayactions,
            frequency::decimal(38, 4) as frequency,
            null as mkwid,
            null as pubcode,
            null as adkey,
            case 
              when lower(right(adcampaign_name, 3)) like 'v%' then right(adcampaign_name, 3)
              else null
            end as campaignverticle,
            _record_insert_date
        from
