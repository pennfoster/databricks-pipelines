...
for i in query_list:
    ...
    select_query = f"""
        select
            ...
            numofflineimpressions::decimal(38, 4) as phonecallimpressions,
            calls::decimal(38, 4) as calls,
            callrate,
            ...
            impressionshare::decimal(38, 4) as impressionshare,
            searchimpressionshare,
            totalavailableimpressions::decimal(38, 4) as availableimpressions,
